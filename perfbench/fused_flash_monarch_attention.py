...
@triton.jit
def flash_monarch_attn_kernel_T2(
    q_ptr,
    stride_q_e,
    stride_q_h,
    stride_q_m,
...
@triton.jit
def flash_monarch_attn_kernel_T1(
    q_ptr,
    stride_q_e,
    stride_q_h,
    stride_q_m,
...
def fused_flash_monarch_attention(q: Tensor, k: Tensor, v: Tensor, B: int, T: int) -> Tensor:
    E, H, N, D = q.shape
    M = triton.cdiv(N, B)
    ...
    if T == 1:
        flash_monarch_attn_kernel_T1[grid](
            q,
            *q_strides,
            k,
            *k_strides,
        ...
        flash_monarch_attn_kernel_T2[grid](
            q,
            *q_strides,
            k,
            *k_strides,
...
def test():
    ...
    fused_flash_monarch_attention(q, k, v, 16, 2)
