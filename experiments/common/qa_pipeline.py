# Adapted from transformers 4.53.3 `pipelines/question_answering.py`
# (Apache-2.0, Copyright The HuggingFace Team), which was removed in transformers 5.
# Changes: dropped TensorFlow branches and deprecated arguments, removed the
# `modelcard` / `framework` constructor arguments (PyTorch only), updated imports.
...
from transformers.utils import PaddingStrategy, add_end_docstrings, is_tokenizers_available, logging
...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    def __call__(self, *args, **kwargs):
        ...
        generator_types = (types.GeneratorType, Dataset)
