...
This saves the trained model to `gps/gps_model.pth`. Training uses AdamW with a learning rate of 5e-4 for 1500 steps.
...
```bash
python -m gps.benchmark
```

Results are saved as JSON files in `gps/results/`. The script evaluates:
