"""
Forked from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/modeling_utils.py
"""

# (Alec:) When I installed diffusers, diffusers.hook did not exist. 
# For now I just forked everything from diffusers.hooks into .hooks
